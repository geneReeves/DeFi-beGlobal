    ...
    RewarderRestriction
{
    ...
    uint256 public constant LOCKUP = 7776000; // lockup of 90 days
    ...
    function deposit(uint256 _amount) public nonReentrant {
        ...
        // if (userExistance[msg.sender] == true) {
        //     userExists = true;
        // }
    ...
    function withdraw() external nonReentrant {
        uint256 amount = availableForWithdraw(block.timestamp, msg.sender);
